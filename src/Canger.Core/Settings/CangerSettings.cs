...
public sealed class CangerSettings(ISettings settings)
{
    ...
    private T Required<T>(string name) where T : notnull =>
        settings.Get<T>(name) ?? (T)SettingsCatalog.Require(name).DefaultValue!;
    ...
    public string? DrawBordersMultipane => settings.Get<string>("draw_borders_multipane");

    /// <summary>The <c>padding_right</c> setting.</summary>
    public bool PaddingRight => settings.Get<bool>("padding_right");

    /// <summary>The <c>collapse_preview</c> setting.</summary>
    public bool CollapsePreview => settings.Get<bool>("collapse_preview");

    /// <summary>The <c>status_bar_on_top</c> setting.</summary>
    public bool StatusBarOnTop => settings.Get<bool>("status_bar_on_top");

    /// <summary>The <c>draw_progress_bar_in_status_bar</c> setting.</summary>
    public bool DrawProgressBarInStatusBar => settings.Get<bool>("draw_progress_bar_in_status_bar");

    /// <summary>The <c>dirname_in_tabs</c> setting.</summary>
    public bool DirnameInTabs => settings.Get<bool>("dirname_in_tabs");

    /// <summary>The <c>hostname_in_titlebar</c> setting.</summary>
    public bool HostnameInTitlebar => settings.Get<bool>("hostname_in_titlebar");

    /// <summary>The <c>tilde_in_titlebar</c> setting.</summary>
    public bool TildeInTitlebar => settings.Get<bool>("tilde_in_titlebar");

    /// <summary>The <c>show_selection_in_titlebar</c> setting.</summary>
    public bool ShowSelectionInTitlebar => settings.Get<bool>("show_selection_in_titlebar");

    /// <summary>The <c>shorten_title</c> setting.</summary>
    public int ShortenTitle => settings.Get<int>("shorten_title");

    /// <summary>The <c>update_title</c> setting.</summary>
    public bool UpdateTitle => settings.Get<bool>("update_title");

    /// <summary>The <c>update_tmux_title</c> setting.</summary>
    public bool UpdateTmuxTitle => settings.Get<bool>("update_tmux_title");
    ...
    public bool RelativeCurrentZero => settings.Get<bool>("relative_current_zero");

    /// <summary>The <c>one_indexed</c> setting.</summary>
    public bool OneIndexed => settings.Get<bool>("one_indexed");

    /// <summary>The <c>unicode_ellipsis</c> setting.</summary>
    public bool UnicodeEllipsis => settings.Get<bool>("unicode_ellipsis");

    /// <summary>The <c>bidi_support</c> setting.</summary>
    public bool BidiSupport => settings.Get<bool>("bidi_support");

    /// <summary>The <c>show_cursor</c> setting.</summary>
    public bool ShowCursor => settings.Get<bool>("show_cursor");

    /// <summary>The <c>display_size_in_main_column</c> setting.</summary>
    public bool DisplaySizeInMainColumn => settings.Get<bool>("display_size_in_main_column");

    /// <summary>The <c>display_size_in_status_bar</c> setting.</summary>
    public bool DisplaySizeInStatusBar => settings.Get<bool>("display_size_in_status_bar");

    /// <summary>The <c>display_free_space_in_status_bar</c> setting.</summary>
    public bool DisplayFreeSpaceInStatusBar => settings.Get<bool>("display_free_space_in_status_bar");

    /// <summary>The <c>display_tags_in_all_columns</c> setting.</summary>
    public bool DisplayTagsInAllColumns => settings.Get<bool>("display_tags_in_all_columns");

    /// <summary>The <c>size_in_bytes</c> setting.</summary>
    public bool SizeInBytes => settings.Get<bool>("size_in_bytes");

    /// <summary>The <c>binary_size_prefix</c> setting.</summary>
    public bool BinarySizePrefix => settings.Get<bool>("binary_size_prefix");

    /// <summary>The <c>hint_collapse_threshold</c> setting.</summary>
    public int HintCollapseThreshold => settings.Get<int>("hint_collapse_threshold");
    ...
    public bool SortReverse => settings.Get<bool>("sort_reverse");

    /// <summary>The <c>sort_case_insensitive</c> setting.</summary>
    public bool SortCaseInsensitive => settings.Get<bool>("sort_case_insensitive");

    /// <summary>The <c>sort_directories_first</c> setting.</summary>
    public bool SortDirectoriesFirst => settings.Get<bool>("sort_directories_first");

    /// <summary>The <c>sort_unicode</c> setting.</summary>
    public bool SortUnicode => settings.Get<bool>("sort_unicode");


    // ---- Filtering and visibility ------------

    /// <summary>The <c>show_hidden</c> setting.</summary>
    public bool ShowHidden => settings.Get<bool>("show_hidden");
    ...
    public bool ClearFiltersOnDirChange => settings.Get<bool>("clear_filters_on_dir_change");

    /// <summary>The <c>show_hidden_bookmarks</c> setting.</summary>
    public bool ShowHiddenBookmarks => settings.Get<bool>("show_hidden_bookmarks");

    /// <summary>The <c>freeze_files</c> setting.</summary>
    public bool FreezeFiles => settings.Get<bool>("freeze_files");


    // ---- Previews ------------

    /// <summary>The <c>preview_files</c> setting.</summary>
    public bool PreviewFiles => settings.Get<bool>("preview_files");

    /// <summary>The <c>preview_directories</c> setting.</summary>
    public bool PreviewDirectories => settings.Get<bool>("preview_directories");

    /// <summary>The <c>preview_images</c> setting.</summary>
    public bool PreviewImages => settings.Get<bool>("preview_images");
    ...
    public bool UsePreviewScript => settings.Get<bool>("use_preview_script");

    /// <summary>The <c>preview_script</c> setting.</summary>
    public string? PreviewScript => settings.Get<string>("preview_script");

    /// <summary>The <c>preview_max_size</c> setting.</summary>
    public int PreviewMaxSize => settings.Get<int>("preview_max_size");

    /// <summary>The <c>wrap_plaintext_previews</c> setting.</summary>
    public bool WrapPlaintextPreviews => settings.Get<bool>("wrap_plaintext_previews");

    /// <summary>The <c>open_all_images</c> setting.</summary>
    public bool OpenAllImages => settings.Get<bool>("open_all_images");

    /// <summary>The <c>iterm2_font_width</c> setting.</summary>
    public int ITerm2FontWidth => settings.Get<int>("iterm2_font_width");

    /// <summary>The <c>iterm2_font_height</c> setting.</summary>
    public int ITerm2FontHeight => settings.Get<int>("iterm2_font_height");

    /// <summary>The <c>w3m_delay</c> setting.</summary>
    public double W3mDelay => settings.Get<double>("w3m_delay");

    /// <summary>The <c>w3m_offset</c> setting.</summary>
    public int W3mOffset => settings.Get<int>("w3m_offset");


    // ---- Navigation and input ------------

    /// <summary>The <c>scroll_offset</c> setting.</summary>
    public int ScrollOffset => settings.Get<int>("scroll_offset");

    /// <summary>The <c>wrap_scroll</c> setting.</summary>
    public bool WrapScroll => settings.Get<bool>("wrap_scroll");

    /// <summary>The <c>mouse_enabled</c> setting.</summary>
    public bool MouseEnabled => settings.Get<bool>("mouse_enabled");

    /// <summary>The <c>flushinput</c> setting.</summary>
    public bool Flushinput => settings.Get<bool>("flushinput");

    /// <summary>The <c>idle_delay</c> setting.</summary>
    public int IdleDelay => settings.Get<int>("idle_delay");

    /// <summary>The <c>xterm_alt_key</c> setting.</summary>
    public bool XtermAltKey => settings.Get<bool>("xterm_alt_key");

    /// <summary>The <c>cd_bookmarks</c> setting.</summary>
    public bool CdBookmarks => settings.Get<bool>("cd_bookmarks");
    ...
    public bool CdTabFuzzy => settings.Get<bool>("cd_tab_fuzzy");


    // ---- Tabs, history and state ------------

    /// <summary>The <c>max_history_size</c> setting.</summary>
    public int? MaxHistorySize => settings.Get<int>("max_history_size");

    /// <summary>The <c>max_console_history_size</c> setting.</summary>
    public int? MaxConsoleHistorySize => settings.Get<int>("max_console_history_size");

    /// <summary>The <c>save_console_history</c> setting.</summary>
    public bool SaveConsoleHistory => settings.Get<bool>("save_console_history");

    /// <summary>The <c>save_tabs_on_exit</c> setting.</summary>
    public bool SaveTabsOnExit => settings.Get<bool>("save_tabs_on_exit");

    /// <summary>The <c>filter_dead_tabs_on_startup</c> setting.</summary>
    public bool FilterDeadTabsOnStartup => settings.Get<bool>("filter_dead_tabs_on_startup");

    /// <summary>The <c>renumber_tabs_on_tab_close</c> setting.</summary>
    public bool RenumberTabsOnTabClose => settings.Get<bool>("renumber_tabs_on_tab_close");

    /// <summary>The <c>autosave_bookmarks</c> setting.</summary>
    public bool AutosaveBookmarks => settings.Get<bool>("autosave_bookmarks");

    /// <summary>The <c>save_backtick_bookmark</c> setting.</summary>
    public bool SaveBacktickBookmark => settings.Get<bool>("save_backtick_bookmark");

    /// <summary>The <c>metadata_deep_search</c> setting.</summary>
    public bool MetadataDeepSearch => settings.Get<bool>("metadata_deep_search");
    ...
    public bool AutomaticallyCountFiles => settings.Get<bool>("automatically_count_files");

    /// <summary>The <c>autoupdate_cumulative_size</c> setting.</summary>
    public bool AutoupdateCumulativeSize => settings.Get<bool>("autoupdate_cumulative_size");
    ...
    public bool VcsAware => settings.Get<bool>("vcs_aware");
    ...
    public int VcsMessageLength => settings.Get<int>("vcs_msg_length");
}
